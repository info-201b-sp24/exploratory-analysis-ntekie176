...
# Load the data
temperature_data <- read.csv("https://raw.githubusercontent.com/melaniewalsh/Neat-Datasets/main/climate-change-earth-surface-temperature-data.csv", stringsAsFactors = FALSE)
```
